...
async def import_services_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    SERVICES = [
        ...
        ("Airbnb", ["airbnb", "airbnb.co.in"], 5.5, [4]),
        ...
        ("Discord", ["discord", "discord.com"], 6.4, [4]),
        ...
        ("Spotify", ["spotify", "spotify.com"], 6.4, [4]),
