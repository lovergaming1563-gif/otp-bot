...
async def import_services_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """One-time bulk service import via Telegram command. Admin only."""
    user_id = update.effective_user.id
    if user_id not in ADMIN_IDS:
        return

    SERVICES = [
        ("1mg", ["1mg", "1mg.com"], 7.6, [6]),
        ("99acres", ["99acres", "99acres.com"], 7.6, [6]),
        ("A23", ["a23", "a23.in"], 5.6, [6]),
        ("Abhibus", ["abhibus", "abhibus.com"], 7.6, [6]),
        ("Acko", ["acko", "acko.com"], 7.6, [6]),
        ("Adda247", ["adda247", "adda247.com"], 9.6, [6]),
        ("Adda52", ["adda52", "adda52.com"], 7.6, [6]),
        ("Air India", ["airindia", "airindia.com"], 7.6, [6]),
        ("Airbnb", ["airbnb", "airbnb.co.in"], 5.5, [4, 6]),
        ("Airtel", ["airtel", "airtel.in"], 7.6, [6]),
        ("AJIO", ["ajio", "ajio.com"], 7.6, [6]),
        ("Amazon", ["amazon.in", "amazon.com"], 7.6, [6]),
        ("Apna", ["apna", "apna.co"], 7.6, [6]),
        ("Apollo", ["apollopharmacy", "apollopharmacy.in"], 7.6, [6]),
        ("Authy", ["authy", "authy.com"], 15.2, [6]),
        ("BigBasket", ["bigbasket", "bigbasket.com"], 6.0, [6]),
        ("Blinkit", ["blinkit", "blinkit.com"], 7.6, [6]),
        ("boAt", ["boat", "boat-lifestyle.com"], 7.6, [6]),
        ("Borzo", ["borzo", "borzo.com"], 7.6, [4]),
        ("Cars24", ["cars24", "cars24.com"], 7.6, [6]),
        ("Chingari", ["chingari", "chingari.com"], 10.0, [6]),
        ("Claude", ["claude", "claude.ai"], 6.4, [4, 6]),
        ("Cleartrip", ["cleartrip", "cleartrip.com"], 7.6, [6]),
        ("CoinDCX", ["coindcx", "coindcx.com"], 7.6, [6]),
        ("CommunityGaming", ["communitygaming", "communitygaming.io"], 7.6, [6]),
        ("ConfirmTkt", ["confirmtkt", "confirmtkt.com"], 6.4, [6]),
        ("Country Delight", ["countrydelight", "countrydelight.com"], 7.6, [6]),
        ("CRED", ["cred", "cred.club"], 7.6, [6]),
        ("CreditMantri", ["creditmantri", "creditmantri.com"], 6.4, [6]),
        ("Croma", ["croma", "croma.com"], 7.6, [6]),
        ("Cursor", ["cursor", "cursor.sh"], 7.6, [6]),
        ("DealShare", ["dealshare", "dealshare.in"], 7.6, [6]),
        ("Delhivery", ["delhivery", "delhivery.com"], 7.6, [6]),
        ("Digio", ["digio", "digio.in"], 8.8, [6]),
        ("Digit Insurance", ["godigit", "godigit.com"], 8.0, [6]),
        ("Dil Mil", ["dilmil", "dilmil.com"], 8.8, [6]),
        ("Discord", ["discord", "discord.com"], 6.4, [4, 6]),
        ("Disney Hotstar", ["hotstar", "hotstar.com"], 6.4, [6]),
        ("Dmart", ["dmart", "dmart.in"], 7.6, [6]),
        ("DocuSign", ["docusign", "docusign.com"], 7.6, [6]),
        ("Dominos", ["dominos", "dominos.co.in"], 5.6, [6]),
        ("Dream11", ["dream11", "dream11.com"], 7.6, [6]),
        ("DriveU", ["driveu", "driveu.com"], 7.6, [6]),
        ("Eloelo", ["eloelo", "eloelo.com"], 7.6, [6]),
        ("Facebook", ["facebook", "facebook.com"], 6.0, [6]),
        ("Fan2Play", ["fan2play", "fan2play.com"], 7.6, [6]),
        ("Fanclash", ["fanclash", "fanclash.in"], 7.6, [6]),
        ("FanCode", ["fancode", "fancode.com"], 7.2, [6]),
        ("FirstCry", ["firstcry", "firstcry.com"], 7.6, [6]),
        ("Flipkart", ["flipkart", "flipkart.com"], 6.0, [6]),
        ("Foundit", ["foundit", "foundit.in"], 6.8, [6]),
        ("FRND", ["frnd", "frnd.com"], 7.6, [6]),
        ("Gamezy", ["gamezy", "gamezy.com"], 7.6, [6]),
        ("GMNG", ["gmng", "gmng.app"], 7.6, [6]),
        ("GoDaddy", ["godaddy", "godaddy.com"], 9.2, [6]),
        ("Healthians", ["healthians", "healthians.com"], 7.6, [6]),
        ("Hinge", ["hinge", "hinge.com"], 7.6, [6]),
        ("IndiaMart", ["indiamart", "indiamart.com"], 7.2, [6]),
        ("INDmoney", ["indmoney", "indmoney.com"], 7.6, [6]),
        ("Instagram", ["instagram", "instagram.com"], 7.6, [6]),
        ("IRCTC", ["irctc", "irctc.co.in"], 7.6, [6]),
        ("Ixigo", ["ixigo", "ixigo.com"], 7.6, [6]),
        ("Jio", ["jio", "jio.com"], 7.6, [6]),
        ("JioMart", ["jiomart", "jiomart.com"], 7.6, [6]),
        ("Josh", ["josh", "joshapp.in"], 7.6, [6]),
        ("Jugnoo", ["jugnoo", "jugnoo.in"], 7.6, [4]),
        ("Justdial", ["justdial", "justdial.com"], 5.5, [6]),
        ("Kaggle", ["kaggle", "kaggle.com"], 6.4, [6]),
        ("Kalyan Jewellers", ["kalyanjewellers", "kalyanjewellers.net"], 7.6, [6]),
        ("KFC", ["kfc", "kfc.co.in"], 7.6, [6]),
        ("KukuFM", ["kukufm", "kukufm.com"], 7.6, [6]),
        ("LazyPay", ["lazypay", "lazypay.com"], 8.0, [6]),
        ("Lenskart", ["lenskart", "lenskart.com"], 7.6, [6]),
        ("LinkedIn", ["linkedin", "linkedin.com"], 5.5, [6]),
        ("LOCO", ["loco", "loco.gg"], 7.6, [6]),
        ("Ludo Supreme", ["ludosupreme", "ludosupreme.com"], 7.6, [6]),
        ("MagicBricks", ["magicbricks", "magicbricks.com"], 7.6, [6]),
        ("MakeMyTrip", ["makemytrip", "makemytrip.com"], 7.6, [6]),
        ("Mamaearth", ["mamaearth", "mamaearth.in"], 7.6, [6]),
        ("McDonalds", ["mcdonalds", "mcdonaldsindia.com"], 5.5, [6]),
        ("MediBuddy", ["medibuddy", "medibuddy.in"], 10.8, [6]),
        ("Meesho", ["meesho", "meesho.com"], 6.0, [6]),
        ("Milkbasket", ["milkbasket", "milkbasket.com"], 7.6, [6]),
        ("MobiKwik", ["mobikwik", "mobikwik.com"], 7.6, [6]),
        ("Motilal Oswal", ["motilaloswal", "motilaloswal.com"], 7.6, [6]),
        ("MPL", ["mpl", "mpl.live"], 7.6, [6]),
        ("Mudrex", ["mudrex", "mudrex.com"], 6.4, [6]),
        ("My11Circle", ["my11circle", "my11circle.com"], 7.6, [6]),
        ("Myntra", ["myntra", "myntra.com"], 7.6, [6]),
        ("Naukri", ["naukri", "naukri.com"], 7.6, [6]),
        ("Navi", ["navi", "navi.com"], 7.6, [6]),
        ("Netflix", ["netflix", "netflix.com"], 5.6, [4, 6]),
        ("Netmeds", ["netmeds", "netmeds.com"], 7.6, [6]),
        ("NoBroker", ["nobroker", "nobroker.in"], 8.8, [6]),
        ("Nykaa", ["nykaa", "nykaa.com"], 7.6, [6]),
        ("Ola Cabs", ["ola", "olacabs.com"], 9.2, [4, 6]),
        ("OneCard", ["onecard", "onecard.com"], 7.6, [6]),
        ("OpenAI", ["openai", "openai.com"], 7.6, [6]),
        ("Otipy", ["otipy", "otipy.com"], 7.6, [6]),
        ("PharmEasy", ["pharmeasy", "pharmeasy.in"], 7.6, [6]),
        ("Physics Wallah", ["pw", "physicswallah.live"], 7.6, [6]),
        ("PlayerzPot", ["playerzpot", "playerzpot.com"], 9.2, [6]),
        ("Porter", ["porter", "porter.in"], 8.8, [4, 6]),
        ("Probo", ["probo", "probo.in"], 7.6, [6]),
        ("Purplle", ["purplle", "purplle.com"], 7.6, [6]),
        ("QuackQuack", ["quackquack", "quackquack.com"], 7.6, [6]),
        ("Rapido", ["rapido", "rapido.bike"], 6.8, [4, 6]),
        ("Reddit", ["reddit", "reddit.com"], 9.6, [6]),
        ("Ring Pay", ["ringpay", "ringpay.com"], 7.6, [6]),
        ("Rooter", ["rooter", "rooter.gg"], 7.6, [6]),
        ("Roposo", ["roposo", "roposo.com"], 6.4, [6]),
        ("Rummy Culture", ["rummyculture", "rummyculture.com"], 10.8, [6]),
        ("Rummy Gold", ["rummygold", "rummygold.com"], 7.6, [6]),
        ("RummyCircle", ["rummycircle", "rummycircle.com"], 10.8, [6]),
        ("Shadowfax", ["shadowfax", "shadowfax.in"], 7.6, [6]),
        ("ShareChat", ["sharechat", "sharechat.co"], 7.6, [6]),
        ("Shiprocket", ["shiprocket", "shiprocket.in"], 7.6, [6]),
        ("Simpl", ["simpl", "simpl.com"], 7.6, [6]),
        ("Smallcase", ["smallcase", "smallcase.com"], 7.6, [4]),
        ("Snapchat", ["snapchat", "snapchat.com"], 7.6, [6]),
        ("Sony LIV", ["sonyliv", "sonyliv.com"], 8.8, [6]),
        ("Spotify", ["spotify", "spotify.com"], 6.4, [4, 6]),
        ("Stan", ["stan", "stan.gg"], 7.2, [6]),
        ("Stock Edge", ["stockedge", "stockedge.com"], 7.6, [6]),
        ("Stockgro", ["stockgro", "stockgro.club"], 5.5, [6]),
        ("Swiggy", ["swiggy", "swiggy.com"], 7.6, [6]),
        ("Tata Cliq", ["tatacliq", "tatacliq.com"], 7.6, [6]),
        ("Tata Neu", ["tataneu", "tataneu.com"], 7.6, [6]),
        ("Testbook", ["testbook", "testbook.com"], 7.6, [6]),
        ("Tira Beauty", ["tira", "tirabeauty.com"], 7.6, [6]),
        ("Truecaller", ["truecaller", "truecaller.com"], 6.4, [6]),
        ("Twilio", ["twilio", "twilio.com"], 7.6, [6]),
        ("Twitter / X", ["twitter", "twitter.com"], 5.5, [6]),
        ("Uber", ["uber", "uber.com"], 7.6, [4, 6]),
        ("Unacademy", ["unacademy", "unacademy.com"], 7.6, [6]),
        ("Upstox", ["upstox", "upstox.com"], 7.6, [6]),
        ("Vercel", ["vercel", "vercel.com"], 7.6, [6]),
        ("WinZO", ["winzogames", "winzogames.com"], 7.6, [6]),
        ("WorkIndia", ["workindia", "workindia.in"], 7.6, [6]),
        ("YouTube", ["youtube", "youtube.com"], 7.6, [6]),
        ("Zepto", ["zepto", "zeptonow.com"], 7.6, [6]),
        ("Zoho", ["zoho", "zoho.com"], 7.6, [6]),
        ("Zomato", ["zomato", "zomato.com"], 7.2, [6]),
        ("Zupee", ["zupee", "zupee.com"], 7.6, [6]),
    ]

    await update.message.reply_text("⏳ Importing services... please wait.")

    from database import db as mongo_db
    inserted = 0
    skipped = 0
    for name, keywords, price, otp_digits in SERVICES:
        existing = await mongo_db.services.find_one({"name": name})
        if existing:
            skipped += 1
            continue
        await mongo_db.services.insert_one({
            "name": name,
            "keywords": keywords,
            "active": True,
            "price": price,
